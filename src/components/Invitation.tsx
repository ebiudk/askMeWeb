...
export default function Invitation({ groupId, isAdmin }: InvitationProps) {
  ...
  return (
    <div className="mt-4 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
      <h3 className="text-sm font-medium text-gray-900 dark:text-white">メンバーを招待</h3>
      ...
      {!inviteUrl ? (
        ...
        <div className="mt-3 space-y-2">
          ...
          <button
            onClick={generateInvite}
            disabled={loading}
            className="text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 font-medium flex items-center"
          >
